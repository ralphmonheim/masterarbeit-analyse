...
Eingaben:
    Variantenordner unter ``0_Input`` mit Raumunterordnern und den erwarteten
    PRN-Dateien je Raum.

Ausgaben:
    Zusammengefuehrte Raumtabellen unter ``1_Datenbank/<Variante>_nutzdaten``.
...
# Es werden genau diese 5 PRN-Dateien je Raum berücksichtigt.
PRN_FILES = ["HEAT_BALANCE.prn", "IAQ.prn", "LOCAL-DE-COMF-DIAG-T.prn", "TEMPERATURES.prn", "ZONE-ENERGY.prn"]
...
def discover_variant_dirs(input_root, rooms=None, debug=False, selected_variants=None):
    ...
    """Findet Variantenordner unter 0_Input, auch ohne Suffix _rohdaten."""
