"""Uebernimmt Namensaenderungen aus Namensmapping.md in Skripte und Doku."""
...
from .config import COMMAND_DOC, PACKAGE_DIR, SUPPORT_DOC_DIR

SCRIPT_DIR = PACKAGE_DIR
DEFAULT_MAPPING_DOC = SUPPORT_DOC_DIR / "Namensmapping.md"
LEGACY_MAPPING_DOC = SUPPORT_DOC_DIR / "0_Namensmapping.md"
...
def collect_target_files() -> list[Path]:
    target_dirs = [SCRIPT_DIR, SUPPORT_DOC_DIR]
    candidates = []
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Liest Skripte/Namensmapping.md und uebernimmt definierte Namensaenderungen."
    )
    parser.add_argument(
        "--mapping-doc",
        default=None,
