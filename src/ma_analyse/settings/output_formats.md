...
| heating.timeline.single.png | heating | timeline | Heating Zeitdiagramm single | 16x9 cm |
| heating.timeline.compare.png | heating | timeline | Heating Zeitdiagramm compare | 16x9 cm |
...
| cooling.timeline.compare.png | cooling | timeline | Cooling Zeitdiagramm compare | 16x9 cm |
| internal-loads.year.png | plot-template | internal-loads-year | Internal Loads Jahresverlauf | 16x9 cm |
| internal-loads.timeline.png | plot-template | internal-loads-month/week/day | Internal Loads Zeitverlauf | 16x9 cm |
| internal-loads.profile.png | plot-template | internal-loads-month/week/day | Internal Loads Profil | 16x9 cm |
| internal-loads.monthly-sum.png | plot-template | internal-loads-monthly-sum | Internal Loads Monatssummen | 16x9 cm |
| internal-loads.room-comparison.png | plot-template | internal-loads-room-comparison | Internal Loads Raumvergleich | 16x9 cm |
| energy-balance.template.png | plot-template | energy-balance | Energiebilanz Zeitdiagramm | 16x9 cm |
| thermal-room-climate.template.png | plot-template | thermal-room-climate | Raumklima-Zeitdiagramm | 16x9 cm |
...
| 12.8x7.2 cm | 12.8 | 7.2 | Kompaktes 16:9-Format für Plot-Templates |
