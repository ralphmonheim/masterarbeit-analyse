...
def run_plot_template(args):
    ...
    output_files = build_plot_template(
        ...
        output_mode=getattr(args, "plot_template_mode", "single"),
        ...
        primary_axis_mode=getattr(args, "primary_axis_mode", "automatic"),
        primary_ymin=getattr(args, "primary_ymin", None),
        primary_ymax=getattr(args, "primary_ymax", None),
        secondary_axis_mode=getattr(args, "secondary_axis_mode", "automatic"),
        secondary_ymin=getattr(args, "secondary_ymin", None),
        secondary_ymax=getattr(args, "secondary_ymax", None),
        month=getattr(args, "month", None),
        week=getattr(args, "week", None),
        day=getattr(args, "day", None),
        run_id=getattr(args, "run_id", None),
...
def build_runtime_args(
    ...
    return argparse.Namespace(
        ...
        plot_template_mode=plot_template_defaults["output_mode"],
        ...
        primary_axis_mode=plot_template_defaults["primary_axis_mode"],
        primary_ymin=plot_template_defaults["primary_ymin"],
        primary_ymax=plot_template_defaults["primary_ymax"],
