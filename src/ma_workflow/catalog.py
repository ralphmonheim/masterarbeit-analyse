...
_MODULE_DEFINITIONS: tuple[ModuleDefinition, ...] = (
    ...
    _module(
        ...
        inputs=("BusinessIntegration-LoD-1-Gebaeude", "Nutzungsanforderungen"),
        outputs=("validierte LoD-1-Zonendaten fuer ma_parameters", "Zonenanforderungen fuer ma_technical"),
        boundaries=("keine Gebaeudegeometrie", "keine automatische Raum-Zonen-Zuordnung", "keine Anlagenberechnung"),
        dependencies=("ma_building",),
        next_step="LoD-2-Raum-Zonen-Zuordnung und belastbare Nutzungsprofilbibliothek planen.",
    ...
    _module(
        ...
        inputs=("validierte LoD-1-Zonendaten", "einfache Referenzsystemannahmen"),
        outputs=("validierte LoD-1-Technikdaten fuer ma_parameters",),
        boundaries=("keine Variantenbildung", "keine Anlagenauslegung", "keine Produktdatenbank"),
        dependencies=("ma_zones",),
        next_step="Referenzsysteme fuer LoD-2 und spaetere Dimensionierung genauer abgrenzen.",
    ...
    _module(
        ...
        outputs=("validierter ParameterSnapshot v1", "Optionsgruppen", "ausgewaehlte Werte"),
        boundaries=("keine Variantenbildung",),
        dependencies=("ma_building", "ma_weather", "ma_zones", "ma_technical"),
        next_step="Stage-1-Dimensionierung und Variantenanbindung auf ParameterSnapshot v1 vorbereiten.",
    ...
    _module(
        ...
        outputs=("LoD-1-Referenzdimensionierung", "Rechenweg", "Dimensionierungshinweise"),
        boundaries=("keine Variantenbildung", "kein normatives Lastverfahren", "keine Ergebnisanalyse der Simulationslaeufe"),
        dependencies=("ma_parameters",),
        next_step="Stage-1-Ergebnis als Folgesnapshot und IDA-Plausibilisierung planen.",
    ...
    _module(
        ...
        dependencies=("ma_workflow",),
        next_step="P010-Freigabevertraege ueber P027 auf weitere Fachmodule anwenden.",
