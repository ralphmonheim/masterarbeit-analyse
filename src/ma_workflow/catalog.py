...
_WORKFLOW_PHASES: tuple[WorkflowPhase, ...] = (
    ...
    WorkflowPhase(
        ...
        2,
        "Wetter-, Gebaeude-, Technik- und Zonendaten erfassen und vereinheitlichen.",
    ),
    WorkflowPhase(
        "phase_3",
...
_MODULE_DEFINITIONS: tuple[ModuleDefinition, ...] = (
    ...
    _module(
        ...
        "planned",
        "workflow",
        "RunManifest, Zeitraum, Zeitschritt, Ausgabeintervall und Szenario fuer erzeugte Varianten festlegen.",
        inputs=("vollstaendige Varianten nach VGEN", "VariantSelection", "Projekt- und Wetterreferenzen"),
        outputs=("RunManifest", "RUN-ID", "direkte RUN -> VAR-Zuordnung"),
        boundaries=("keine Variantenbildung", "keine Simulationsdateibearbeitung"),
        dependencies=("ma_variants",),
        next_step="P018: RunManifest mit direkter VAR-ID-Referenz und Standard-Jahressimulation planen.",
    ...
    _module(
        ...
        dependencies=("ma_export_simulation",),
        next_step="Zuordnung ueber RUN-ID und VAR-ID nach P018/P009 inventarisieren.",
...
_WORKFLOW_STEPS: tuple[WorkflowStep, ...] = (
    ...
    _step("workflow", "Workflow-Steuerung", "phase_0", "ma_workflow", "Phasen, Modulstatus und P017-Checkpoints orchestrieren."),
    _step(
    ...
    _step("technical", "Technische Systeme", "phase_2", "ma_technical", "Referenzsysteme, Grenzen und Technikdaten erfassen."),
    _step("zones", "Zonendaten", "phase_2", "ma_zones", "Zonen, Nutzungen, Profile und lokale Uebergabe festlegen."),
    _step(
        "parameters",
    ...
    _step(
        ...
        "phase_3",
        "ma_simulation_setup",
        "RunManifest mit direkter RUN-zu-VAR-Zuordnung festlegen.",
    ),
    _step(
        "export_simulation",
