...
_MODULE_DEFINITIONS: tuple[ModuleDefinition, ...] = (
    ...
    _module(
        ...
        "planned",
        "workflow",
        "Projektstammdaten, Untersuchungsziele, Randbedingungen und Projektstatus verwalten.",
        inputs=("Projektangaben", "Standardvorlagen"),
        outputs=("Projektkonfiguration", "Bewertungsziele", "Projektstatus"),
        dependencies=("ma_core",),
    ...
    _module(
        ...
        outputs=("validierte zentrale Parameterliste",),
        boundaries=("keine Variantenbildung",),
    ...
    _module(
        ...
        "available",
        "workflow",
        "Technische Auswertung der standardisierten Simulationsergebnisse bereitstellen.",
        ...
        next_step="Bestehende Stufen 2 bis 4 weiter ueber Services stabilisieren.",
    ...
    _module(
        ...
        inputs=("zentrale Parameterliste aus ma_parameters",),
...
_WORKFLOW_STEPS: tuple[WorkflowStep, ...] = (
    ...
    _step(
        "analyse",
        "Technische Analyse Stufe 2 bis 4",
        "phase_4",
        "ma_analyse",
        "Optimierung, Nachweise und Sensitivitaet auswerten.",
    ),
