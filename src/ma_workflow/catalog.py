...
_MODULE_DEFINITIONS: tuple[ModuleDefinition, ...] = (
    ...
    _module(
        ...
        inputs=("BuildingModelSpecification", "lokale IFC-/3DM-Diagnosequellen"),
        outputs=("validierbare Demo-Gebaeudedaten", "strukturierte Quelldiagnosen"),
        boundaries=("kein produktiver IFC-/Rhino-Import", "keine Zonenprofile", "keine technische Anlagenlogik"),
        dependencies=("ma_project",),
        next_step="Reale IFC-Inhalte auswerten und IFC-Lite-Umfang getrennt freigeben.",
