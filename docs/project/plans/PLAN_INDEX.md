...
| P007 | Projektplan fuer die VS-Code-Umsetzung der Masterarbeitssoftware | `inbox/Masterarbeit_VSCode_Projektplan_2026-06-21.md` | Gesamtprojekt, Gesamtarchitektur | Aktiver Rahmenplan | Hoch | bestehender Projektstand und Nutzerentscheidungen | P010 als naechste aktive Strukturstufe bearbeiten |
| P008 | Wettermodul Abschluss, Dateiimport und P007-Anbindung | `inbox/260621_Plan_P008_Wettermodul_Abschluss_P007_Anbindung.md` | ma_weather, ma_parameters, Stage 4 | Aktiv | Hoch | P007, P002, P010 | Realtests, eigene Wetterimporte und Ereignisschnittstelle planen |
...
| P010 | Eingabe- und Datenhaltungsarchitektur | `inbox/260622_Plan_P010_Eingabe_Datenhaltungsarchitektur.md` | alle Eingabemodule, ma_database | Aktiv | Hoch | P007 | Quellen-, Diagnose- und Validierungsvertraege konkretisieren |
...
| P028 | Projekt-, Parameter- und Naming-Demo in Streamlit | `inbox/260623_Plan_P028_Projekt_Parameter_Naming_Streamlit.md` | ma_project, ma_parameters, ma_variants, ma_ui | Geplant | Hoch | P010, P011, P015, P017, P027 | Demo-Datenfluss und geschuetzte lokale Konfiguration umsetzen |
