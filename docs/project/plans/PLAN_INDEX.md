...
|---|---|---|---|---|---|---|---|
| P001 | Variantenmodul GUI und Logikpruefung | `inbox/250603_Plan_Variantenmodul_GUI_Logikpruefung.md` | ma_variants, ma_analyse GUI | Teilweise umgesetzt | Hoch | P003, stabile Pfadstruktur | Streamlit-UI manuell pruefen, danach archivieren |
| P002 | Wetterdatenanalyse TRY Modul Integration | `inbox/250603_Plan_Wetterdatenanalyse_TRY_Integration.md` | ma_weather | Entwurf | Mittel | P003, aktueller Release-Stand | Nach Release 0.5.1 pruefen und konkrete Integration des Wettermoduls vorschlagen |
