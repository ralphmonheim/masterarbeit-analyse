# Archivierte Leitfaeden

Dieser Ordner enthaelt alte oder externe Leitfadenfassungen. Die Dateien werden
nicht als aktive Steuerdokumente verwendet, sondern dienen als Referenz und
Vergleichsbasis.

Andere Archivbereiche:

- `docs/project/archive/plans/`: archivierte und alte Planstaende.

Aktive Leitfadenfassung:

- `docs/project/MASTERARBEIT_LEITFADEN.md`

Archivierte Fassungen:

| Datei | Version | Quelle | Zweck |
|---|---|---|---|
...
grundlegend umgebaut wird. Normale inhaltliche Weiterentwicklung passiert in
der aktiven Datei.
