...
- Keine eigenstaendige Katalogstruktur unter `config/ma_variants/parameters`, `config/ma_variants/options`, `config/ma_variants/systems` oder `config/ma_variants/naming`.
...
- `config/ma_variants/parameters/example_parameters.json`
- `config/ma_variants/options/example_options.json`
- `config/ma_variants/systems/example_system_templates.json`
- `config/ma_variants/naming/example_naming_rules.json`
...
1. Beispielparameter in `config/ma_variants/parameters` pflegen.
2. Beispieloptionen in `config/ma_variants/options` pflegen.
...
9. Reporting-Modul exportiert eine Variantenuebersicht nach `data/ma_variants/exports`.
...
- `docs/project/plans/inbox/PLAN_Projektplan_Version_1_0_0.md` als Planungsbasis anlegen.
- Spaeter ergaenzen:
  - `docs/ma_variants/workflow.md`
  - `docs/ma_variants/data_model.md`
...
- `config/ma_variants/parameters`, `config/ma_variants/options`, `config/ma_variants/systems`, `config/ma_variants/naming` anlegen.
- `data/ma_variants/imports`, `data/ma_variants/exports`, `data/reports` anlegen.
